          ...
          <div className="mt-12 card bg-gradient-to-br from-primary/5 via-base-200 to-accent/5 border border-primary/20">
            <div className="card-body">
              ...
              <p className="text-base-content/70 mb-6 text-center max-w-xl mx-auto">
                Upgrade to a premium membership to access your personal dashboard where you can view all your QR codes, track scans, and get detailed analytics on usage.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm mb-1">Scan Analytics</h3>
                    <p className="text-sm text-base-content/60">Track how many times your QR codes are scanned</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm mb-1">Organize QR Codes</h3>
                    <p className="text-sm text-base-content/60">View and manage all your QR codes in one dashboard</p>
                  </div>
                </div>
              </div>
